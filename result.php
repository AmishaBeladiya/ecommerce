    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#"> <i class="fa fa-truck" style="font-size: 18px;"></i>&nbsp;Shopping Cart</a></li>
                <li><a href="#">Total:-<?php total_item();?></a></li>
                <li class="dropdown">
...
<section id="feature">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $get_product = "select * from products where product_keywords like '%$user_query%'";
