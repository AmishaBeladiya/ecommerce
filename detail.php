            	...
            	<div class='col-sm-6 col-md-4'>
                     ...
                     <div class='row'>
                        <div class='col-md-4'>
                         ...
                         <div class='col-md-4'>
                            <img src='admin/product_img/$pro_img2' class='img-responsive' style=' margin-left:90px; max-width:250px; max-height:150px;'>
                         </div>
                         <div class='col-md-4'>
                            <img src='admin/product_img/$pro_img3' class='img-responsive' style=' margin-left:90px; max-width:250px; max-height:150px;'>
                         </div>
                     </div>
